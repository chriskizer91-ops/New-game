export default [
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        structuredClone: 'readonly', globalThis: 'readonly', TextEncoder: 'readonly', TextDecoder: 'readonly', btoa: 'readonly', atob: 'readonly', Image: 'readonly', PointerEvent: 'readonly', ResizeObserver: 'readonly', getSelection: 'readonly', scrollTo: 'readonly', devicePixelRatio: 'readonly', Node: 'readonly', Element: 'readonly', HTMLElement: 'readonly', DocumentFragment: 'readonly', CustomEvent: 'readonly', Event: 'readonly', DOMParser: 'readonly', HTMLCanvasElement: 'readonly', KeyboardEvent: 'readonly',
      },
    },
